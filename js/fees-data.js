...
export const FEES = {
  "meta": {
    ...
    "nuances": {
      ...
      "offsiteAdsBase": "Offsite Ads % applies to the total order amount including shipping (and taxes in some jurisdictions); capped at 100 USD per attributed order.",
    ...
    "june2026RegulatoryChanges": {
      "note": "Effective 2026-06-22. Old rates per valueaddedresource.net (Etsy overwrote official pages); new rates confirmed on Etsy's official help page 2026-07-22.",
      "GB": {
        "old": 0.0032,
        "new": 0.0048
      },
